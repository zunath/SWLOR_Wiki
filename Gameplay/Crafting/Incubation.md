...
1) First you will need the Bioengineer perks, these are gained through beast mastery, so first step is to tame yourself up a wild beast and level up your Beast Mastery! 
2) Access to a Lab. This can be joining a player town that already has one built and getting access permissions (Some labs are set to public) or you will need 5 other players to get together and build your own player settlement to construct your own (obviously this is not the ideal route unless you intend to make a town already)
3) An incubation station (or three if you max the Incubation Management perk), these are crafting stations that can only be placed inside a lab, hence the requirement for a lab.
4) A boat load of patience and willingness to put up with the pain that is RNG (Do not think I'm joking... I am dead serious)
5) Possibly a DNA extractor crafted by a Fabricator, those technically this is an optional step.

Now that you know the pre-reqs, lets next look into what you will need to perform a SINGLE beast incubation. 
1) DNA of a beast, this can be obtained in two ways: Either from taming and releasing a beast OR from getting a DNA extractor and extracting DNA. You will see after you have fully looted a dead beast, their corpse will remain, this is when you use the extractor on them.
2) THREE of each enzyme type. So 3 Lyase, 3 Hydrolase, and 3 Isomerase. 
3) Three days time. Yes, incubation takes a total of roughly three IRL days, this will be explained later. 
...
1) With your enzymes and DNA in hand, interact with the Incubation station. If it does not pop up a menu, look at your combat log, it may be possible someone else is currently using that station. Only one person can use a station at a time, and only the person that starts the process may interact with it until they are done.
2) When the menu does pop up, you will see four empty boxes. Click on the DNA one and it will change your cursor to the interact mode. Now click on the DNA you plan to use for the incubation, this will slot it into the menu.
3) You then do the same thing as above but with the corresponding Enzymes.
4) Click the big start button at the bottom and congrats, you've just started your first beast incubation! However you're not done yet!
5) After roughly 20ish hours (time varies depending on reduction from incubation processing perk and SOC rank) you will go and perform steps 3-4 again. This sill start the second incubation phase of three. 
6) Same thing as step 5, this will start the third and final incubation phase.
7) After about 3 days time, provided you went back each day, you will return and find a nice  "Complete" button on the menu. Click that and you should find an egg in your inventory. 
8) Congrats! You just finished your first incubation. Now you can interact with the egg to hatch it, or you can take it to give to a friend or sell to a stranger. 
...
# Retho's Visiual Guide to Mutations
NOTE: The sizes are not accurate in the images for all beasts, just the visial model.
https://drive.google.com/file/d/1HtNL4eUAsZykPol4gUzFUA_1S_pC6-ge/view?usp=sharing